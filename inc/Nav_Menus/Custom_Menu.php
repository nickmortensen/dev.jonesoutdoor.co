<?php
/**
 * WP_Rig\WP_Rig\Custom_Menus\Custom_Menu class
 *
 * @package wp_rig
 */
...
/**
 * Class for managing Custom Menus.
 */
class Custom_Menu {
	...
	*/
	...
	public function add_custom_menu_item_fields( $menu_item ) {
		$menu_item->subtitle = get_post_meta( $menu_item->ID, 'menu_item_subtitle', true );
	}
	...
	public function initialize() {
		...
		add_filter( 'walker_nav_menu_start_el', [ $this, 'filter_custom_menu' ], 10, 4 );
		add_filter( 'wp_setup_nav_menu_item', [ $this, 'add_custom_menu_item_fields' ], 10, 1 );
	}
