...
# Jones Outdoor: WordPress Theme Based on WP Rig
...
## A Slight Alteration on WP Rig
Since I have phpcs in my root - there was no need to use Composer to download all the acoutremants that come along with WP Rig if I wanted to use PHPCS.
